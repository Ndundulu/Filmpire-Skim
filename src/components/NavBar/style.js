...
export const StyledAppBar = styled(AppBar)(({ theme }) => ({
  color: "white", // This sets the text/icon color to white
  backgroundColor: theme.palette.mode === 'dark' ? theme.palette.background.default : '#008080', // Use backgroundColor instead of filter
}));
